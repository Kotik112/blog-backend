...
public record BlogPostDto(
        ...
        @Schema(description = "Unique ID of the blog post", example = "101")
        Long id,

        @Schema(description = "Title of the blog post", example = "My First Spring Boot Post")
        String title,

        @Schema(description = "Content of the blog post", example = "This is the full content of my post...")
        String content,
        ...
        @Schema(description = "List of likes associated with this post")
        Set<LikeDto> likes,

        @Schema(description = "List of comments on the blog post")
        Set<CommentDto> comments,

        @Schema(description = "Image metadata if an image is attached")
        ImageDto image
) {
