...
public record ImageDto(
    @Schema(description = "Unique ID of the image", example = "301") long id,
    @Schema(description = "Name of the image file", example = "featured-image.png") String name,
    @Schema(description = "MIME type of the image", example = "image/png") String type,
    @Schema(
